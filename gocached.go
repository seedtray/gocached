...
func main() {
  ...
  /*
    var storage_choice = flag.String("storage", "generational", "storage implementation (generational, heap, map)")
    var expiring_frequency = flag.Int64("expiring-interval", 10, "expiring interval in seconds")
  */
  ...
  */
  ...
  if *partitions > 1 {
    ...
    updatesChannel := make(chan UpdateMessage, 50000)
